...
[![x-cmd/install — kcctl Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/kcctl.svg)](https://x-cmd.com/install/kcctl)
...
Total: **7,387** lines of code across **122** files in the top 5 languages.
...
- **Upstream**: <https://github.com/kcctl/kcctl>
- **License**: Apache-2.0
...
- **Stars**: 428 · **Forks**: 46 · **Open issues**: 115 · **Contributors**: 20

## Totals (cumulative)

- **Releases**: 13 · **Merged PRs**: 279 · **Open PRs**: 7 · **Closed issues**: 85 · **Open issues**: 30 · **Commits**: 425
...
_Snapshot: `data/card/260923.yml` · 2026-09-23T05:07:04Z._
